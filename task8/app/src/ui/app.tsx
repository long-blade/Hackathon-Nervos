    ...
    return (
        <div>
            ...
            <div className="card mb-4 p-4">
                <div className="row">
                    <div className="col">
                        <h3>Your Layer 2 Deposit address:</h3> 
                        <b>{l2DepositAddress || ' - '}</b>
                        <br />
                        <br />
                    </div>
                    <div className="col">
                        <small className="text-danger d-block">Make sure that your Layer 2 Deposit Address is added as a  Receiver address in the Force Bridge website</small>
                        Please use the <a target="_blank" href={'https://force-bridge-test.ckbapp.dev/bridge/Ethereum/Nervos?xchain-asset=' + l2DepositAddress}>Force Bridge website</a>: 
                    </div>
                </div>
            </div>
